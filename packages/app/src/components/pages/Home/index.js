...
import { faChevronCircleDown, faChevronCircleUp, faFileImage, faEllipsisV, faCog, faTimes, faPencilAlt } from '@fortawesome/free-solid-svg-icons'
import ApplicationViewByStages from './ApplicationViewByStages';
library.add(fab, faChevronCircleDown, faChevronCircleUp, faFileImage, faEllipsisV, faCog, faTimes, faPencilAlt)
