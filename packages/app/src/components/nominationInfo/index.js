		...
		<div className={styles.layout}>
			{
				...
				!props.hasBeenClicked && !props.saveConfirm ? (
					<div>
						<ApplicationDetail
              ...
              gridContent={true}
					...
					<div>
						...
						<ApplicationUpdateDetailNew
							saveHasBeenClicked={props.saveHasBeenClicked}
							propsData={patientInfo}
			...
			<HealthProviderDetail
				propsData={fields}
				gridContent={true}
				title='Health Provider Information'
			/>
		</div>
	);
}
